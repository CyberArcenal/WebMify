      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            These Terms & Conditions govern your use of my portfolio website
            located at darius-portfollio.vercel.app. By accessing or using the
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            graphics, logos, and images, is my property or the property of my
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 mb-4 space-y-2">
            ...
            <li>
              Engage in any activity that could damage or impair the site's
              functionality
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            any kind. I make no representations or warranties about the
            accuracy, reliability, completeness or timeliness of the content.
          </p>
          <p className="text-gray-600 dark:text-gray-300">
            I shall not be liable for any damages arising from the use of this
            site or its content.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            ...
            provided for convenience only, and I have no control over nor
            responsibility for the content of these sites.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            I reserve the right to modify these terms at any time. Continued use
