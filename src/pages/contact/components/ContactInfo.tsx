...
import MapModal from '@/components/UI/MapModal'; // import ang bagong modal
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              {/* Palitan ang href="#map" ng button na nagbubukas ng modal */}
              <button
                onClick={() => setMapModalOpen(true)}
                className="text-primary hover:text-primary-dark text-sm mt-2 inline-block focus:outline-none"
              >
                View on map
              </button>
            </div>
